...
We define y(u,i) as the rating for movie i by user u and denote our prediction with ˆyu,i. The RMSE is then defined as <TODO>.
...
εi,u = independent errors sampled from the same distribution centered at 0.

μ = true rating for all movies


The estimate that minimizes the RMSE is the least squares estimate of μ and which is the mu_hat: the average rating of all movies across all users
...
bu_hat= Yu,i-μ_hat 
since the least squares estimateˆbu is just the average of Yu,i − ˆμ for each
user u. 
