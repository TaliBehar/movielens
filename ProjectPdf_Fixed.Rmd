...
outliers can be interuped as b's "mistakes" -
  ...
  * Users that systematically rates only 1 stars or only 5 stars 
...
```
  * Predict the rarings - how much our prediction improves once using y=mu+b_i+b_ui
...
we will try to "fix" it by the penalizing, and reduse very large absulute values of ${b_{i}}$ and ${b_{u,i}}$
